...
Комплект документации для симуляционного стенда роя автономных агентов. Отчет основан на фактических артефактах ветки `fix/wkr-experiment-validation`: таблицах из `docs/tables/wkr`, графиках из `docs/figures/wkr`, UML/data-flow описании стенда и описании экспериментальной методики.
